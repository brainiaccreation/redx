                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                {{-- <a href="{{ route('admin.members.list') }}" class="btn btn-secondary"><i
                                        class="fas fa-arrow-left me-2"></i>Back to Members</a> --}}
                            </div>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form class="row g-3" method="POST" action="{{ route('admin.user.store') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                        id="first_name" name="name" value="{{ old('first_name') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('towncity') is-invalid @enderror"
                                        id="city" name="towncity" value="{{ old('towncity') }}" placeholder="City">
                                    @error('towncity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control form-select @error('role') is-invalid @enderror"
                                        ...
                                        @foreach (['admin', 'staff', 'customer'] as $role)
                                            <option value="{{ $role }}"
                                                {{ old('role') == $role ? 'selected' : '' }}>{{ ucfirst($role) }}</option>
                                        @endforeach
                                    </select>
                                    @error('role')
                                        <div class="invalid-feedback">{{ $message }}</div>
