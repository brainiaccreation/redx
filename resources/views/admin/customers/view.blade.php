        ...
        <div class="container-fluid">
            <div class="profile-foreground position-relative mx-n4 mt-n4">
                <div class="profile-wid-bg">
                    <img src="{{ asset('admin/assets/images/profile-bg.jpg') }}" alt="" class="profile-wid-img" />
                </div>
            </div>
            <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                <div class="row g-4">
                    <div class="col-2">
                        <div class="avatar-lg">
                            <img src="{{ $user->avatar ? asset($user->avatar) : asset('admin/assets/images/users/avatar-1.jpg') }}"
                    ...
                    <div class="col-6">
                        <div class="p-2">
                            ...
                            <p class="text-white ">{{ ucfirst($user->account_type) }}</p>
                            <div class="hstack text-white gap-1">
                                @if ($user->city && $user->country)
                                    <div class="me-2">
                                        <i class="ri-map-pin-user-line me-1 text-white  fs-16 align-middle"></i>
                    ...
                    <!--end col-->
                    <div class="col-4 order-last order-lg-0">
                        <div class="row text text-white-50 text-center">
                            ...
                            <div class="col-lg-6 col-6">
                                <div class="p-2">
                                    <h4 class="text-white mb-1">
                                        {{ wallet_balance_format($user->wallet_balance) }}
                                    </h4>
                                    <p class="fs-14 mb-0 text-white">Wallet Balance in ({{ config('app.currency') }})</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-borderless mb-0">
                                                        <tbody>
                                                            ...
                                                            @if ($user->address)
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Address Line 1 :</th>
                                                                    <td class="text-muted">{{ $user->address }}</td>
                                                                </tr>
                                                            @endif
                                                            @if ($user->address2)
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Address Line 2 :</th>
                                                                    <td class="text-muted">{{ $user->address2 }}</td>
                                                                </tr>
                                                            @endif
                                                            ...
                                                            @endif
                                                            <tr>
                                                                <th class="ps-0" scope="row">Account Type :</th>
                                                                <td class="text-muted">{{ ucfirst($user->account_type) }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Signing Date :</th>
                                                                <td class="text-muted">
                                                                    {{ runTimeDateFormat($user->created_at) }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-body p-4">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                                                <h5 class="fs-14 text-truncate"><a href="#"
                                                                        class="text-body">ABC Project Customization</a>
                                                                </h5>
                                                                <p class="text-muted text-truncate mb-0">Last Update :
