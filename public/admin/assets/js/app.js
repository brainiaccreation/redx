!(function () {
    ...
    sessionStorage.getItem("defaultAttribute")
        ? (((h = {})["data-layout"] = sessionStorage.getItem("data-layout")),
          ...
          (h["data-preloader"] = sessionStorage.getItem("data-preloader")),
          (h["data-body-image"] = sessionStorage.getItem("data-body-image")),
          (h["data-theme"] = sessionStorage.getItem("data-theme")),
          (h["data-theme-colors"] =
        ...
        (I = document.getElementById("search-options")) &&
            (I.addEventListener("focus", function () {
                0 < I.value.length
                    ? (v.classList.add("show"), f.classList.remove("d-none"))
